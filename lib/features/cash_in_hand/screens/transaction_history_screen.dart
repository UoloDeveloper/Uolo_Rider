                ...
                child: Row(children: [
                  Expanded(
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text(PriceConverterHelper.convertPrice(cashInHandController.transactions![index].amount), style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
