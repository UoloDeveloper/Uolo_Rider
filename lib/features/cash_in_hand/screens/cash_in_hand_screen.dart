                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                                Row(
                                  children: [
                                    ...
                                    Text('payable_amount'.tr, style: PoppinsMedium.copyWith(color: Theme.of(context).cardColor)),
                                  ],
                                ),
                                const SizedBox(height: Dimensions.paddingSizeDefault),

                                Text(PriceConverterHelper.convertPrice(profileController.profileModel!.payableBalance), style: PoppinsBold.copyWith(fontSize: Dimensions.fontSizeOverLarge, color: Theme.of(context).cardColor)),
                              ]),
                            ),
                            ...
                            Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                              ...
                              profileController.profileModel!.adjustable! ? InkWell(
                                                ...
                                                Expanded(
                                                  child: InkWell(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: !cashInHandController.isLoading ? Text('ok'.tr, style: PoppinsBold.copyWith(color: Theme.of(context).cardColor, fontSize: Dimensions.fontSizeLarge),)
                                ...
                                child: Container(
                                  ...
                                  child: Text('adjust_payments'.tr, textAlign: TextAlign.center, style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).cardColor)),
                                ),
                              ) : const SizedBox(),
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Text('pay_now'.tr, textAlign: TextAlign.center, style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).cardColor)),
                                ),
                              ),
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                              ...
                              Text('cash_in_hand'.tr, style: PoppinsRegular.copyWith(color: Theme.of(context).disabledColor)),
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                              ...
                              Text('total_withdrawn'.tr, style: PoppinsRegular.copyWith(color: Theme.of(context).disabledColor)),
                        ...
                        child: Row(children: [
                          ...
                          InkWell(
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              Text('wallet_provided_earning'.tr, style: PoppinsMedium.copyWith(
                          ...
                          return Column(children: [
                            ...
                            Padding(
                              ...
                              child: Row(children: [
                                Expanded(
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    Text(PriceConverterHelper.convertPrice(cashInHandController.transactions![index].amount), style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeDefault), textDirection: TextDirection.ltr,),
                                    const SizedBox(height: Dimensions.paddingSizeExtraSmall),

                                    Text('${'paid_via'.tr} ${cashInHandController.transactions![index].method?.replaceAll('_', ' ').capitalize??''}', style: PoppinsRegular.copyWith(
                            ...
                            return Column(children: [
                              ...
                              Padding(
                                ...
                                child: Row(children: [
                                  Expanded(
                                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      Text(PriceConverterHelper.convertPrice(cashInHandController.walletProvidedTransactions![index].amount), style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeDefault), textDirection: TextDirection.ltr,),
                                      const SizedBox(height: Dimensions.paddingSizeExtraSmall),

                                      Text('${'wallet'.tr} ${cashInHandController.walletProvidedTransactions![index].method?.replaceAll('_', ' ').capitalize??''}', style: PoppinsRegular.copyWith(
                                        fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor,
                                      )),
                                    ]),
                                  ),
                                  Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                                    ...
                                    Text(cashInHandController.walletProvidedTransactions![index].status!.tr, style: PoppinsRegular.copyWith(
