...
class ConditionCheckBoxWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(mainAxisAlignment: fromSignUp ? MainAxisAlignment.start : MainAxisAlignment.center, children: [
      ...
      fromSignUp ? const SizedBox() : const Text( '*', style: PoppinsRegular),
        ...
        child: RichText(
          text: TextSpan(children: [
            TextSpan(
              ...
              style: PoppinsRegular.copyWith(color: fromSignUp ? Theme.of(context).textTheme.bodyMedium!.color : Theme.of(context).hintColor),
            ),
            const TextSpan(text: ' '),
            TextSpan(
