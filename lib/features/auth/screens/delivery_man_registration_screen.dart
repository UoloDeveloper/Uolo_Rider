                            ...
                            child: authController.pickedImage != null ? GetPlatform.isWeb ? Image.network(
                              ...
                              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                ...
                                Text(
                                  ...
                                  style: PoppinsMedium.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall), textAlign: TextAlign.center,
                                ),
                              ]),
                            ),
                          ),
                                ...
                                child: DottedBorder(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                      ...
                                      Text('upload_identity_image'.tr, style: PoppinsMedium.copyWith(color: Theme.of(context).disabledColor)),
                                    ]),
                                  ),
                                ),
                              );
