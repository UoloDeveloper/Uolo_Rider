              ...
              child: Container(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  widget.fromPasswordChange ? SizedBox(
                    ...
                    child: Text('please_enter_your_new_password_and_confirm_password'.tr, style: PoppinsRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withOpacity(0.5)), textAlign: TextAlign.center),
                  ) : Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                    Text('number_verification_is_successful'.tr, style: PoppinsBold.copyWith(fontWeight: FontWeight.w600)),
                    const SizedBox(height: 5),

                    Text('please_set_your_new_password'.tr, style: PoppinsRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withOpacity(0.5))),
                  ]),
