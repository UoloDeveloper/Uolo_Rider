    ...
    return Container(
      ...
      child: Column(children: [
        ...
        Row(children: [
          ...
          Text('#${orderModel.id}', style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
        ...
        Row(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.start, children: [
          ...
          parcel ? Container(
            ...
            child: Text('parcel'.tr, style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).primaryColor)),
          ) : const SizedBox(),
        ]),
